**UPDATE 12/16**: After spending months building a production-level GraphQL server complete with auth+ACL, I do not recommend the server-side approach described in this tutorial, and recommend using the following libs instead:
